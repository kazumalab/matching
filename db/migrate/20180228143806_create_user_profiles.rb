class CreateUserProfiles < ActiveRecord::Migration[5.1]
  def change
    create_table :user_profiles do |t|
      ...
      t.integer :date_cost_at_first,     limit: 1, default: 0, null: false, unsigned: true # 初デートの費用 0:未選択
      t.integer :date_cost_after_second, limit: 1, default: 0, null: false, unsigned: true # 2回目以降のデートの費用 0:未選択
